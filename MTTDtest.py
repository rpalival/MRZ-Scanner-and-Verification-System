...
from MRTD import decode,encode,mismatch,checkDigit

#Mock Classes for Hardware Scanner which has sample data in form of a string
class MockResponse():
...
class TestMRTD(unittest.TestCase):
    ...
    def test_decode1(self, mock_obj1):
    ...
    def test_decode2(self, mock_obj2):
    ...
    def test_encode(self, mock_obj3):
    ...
    def test_encode1(self, mock_obj4):
    ...
    def test_encode2(self, mock_obj5):
    ...
    #Test case 7: to test mismatch function by checking the hardware scanner check digit with the computed check digit from database
